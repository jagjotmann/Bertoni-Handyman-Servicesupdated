    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="p-12 bg-white rounded-lg shadow-md w-96">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <label className="block text-lg font-medium text-gray-600">Enter your email</label>
            <input
              type="email"
              className={`mt-2 p-3 w-full border rounded-md ${errors.email ? 'border-red-500' : ''}`}
              placeholder=""
              value={email}
          ...
          <div>
            <label className="block text-lg font-medium text-gray-600">Enter a password (at least 8 characters)</label>
            <input
              type="password"
              className={`mt-2 p-3 w-full border rounded-md ${errors.password ? 'border-red-500' : ''}`}
              placeholder=""
              value={password}
